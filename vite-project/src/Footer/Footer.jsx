...
function Footer() {
    return(<>
        <div className="footer">
            <div className="container pd-l pd-r">
                <div className="footer_elements row">
                    <div className="col">
                        <h4>Hachi Pet</h4>
                        <p> Somos uma empresa de vendas alimentos e produtos relacionados a animais domesticos</p>
                    </div>
                    <div className="col col-1  ">
                        <ul className="mt-1">
                            <li className="footer-menu-item"><a href="#">Trocas e devoluções</a></li>
                            <li className="footer-menu-item"><a href="#">Política de envios</a></li>
                            <li className="footer-menu-item"><a href="#">Contato</a></li>
                        </ul>
                    </div>
                    <div className="col col-1 card">
